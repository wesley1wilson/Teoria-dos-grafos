...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Grafo sem ciclo
        self.g_gsc = MeuGrafo(['J', 'C', 'E', 'P', 'M', 'T', 'X', 'Y', 'Z'])
        self.g_gsc.adicionaAresta('a1', 'J', 'C')
        self.g_gsc.adicionaAresta('a2', 'C', 'E')
        self.g_gsc.adicionaAresta('a3', 'E', 'P')
        self.g_gsc.adicionaAresta('a4', 'P', 'M')
        self.g_gsc.adicionaAresta('a5', 'M', 'T')
        self.g_gsc.adicionaAresta('a6', 'X', 'J')
        self.g_gsc.adicionaAresta('a7', 'Z', 'Y')

        self.g_gsc2 = MeuGrafo(['A', 'B', 'C', 'D', 'E', 'F'])
        self.g_gsc2.adicionaAresta('a1', 'A', 'B')
        self.g_gsc2.adicionaAresta('a2', 'B', 'C')
        self.g_gsc2.adicionaAresta('a3', 'C', 'D')
        self.g_gsc2.adicionaAresta('a4', 'D', 'E')
        self.g_gsc2.adicionaAresta('a5', 'E', 'F')

        # Minimum Spanning Tree
        self.MST = MeuGrafo(['0', '1', '2', '3', '4', '5', '6', '7', '8'])
        self.MST.adicionaAresta("a1", '0', '1', 6)
        self.MST.adicionaAresta("a2", '1', '2', 5)
        self.MST.adicionaAresta("a3", '2', '3', 7)
        self.MST.adicionaAresta("a4", '3', '4', 12)
        self.MST.adicionaAresta("a5", '4', '5', 8)
        self.MST.adicionaAresta("a6", '5', '6', 1)
        self.MST.adicionaAresta("a7", '6', '7', 2)
        self.MST.adicionaAresta("a8", '7', '0', 3)
        self.MST.adicionaAresta("a9", '7', '1', 15)
        self.MST.adicionaAresta("a10", '7', '8', 8)
        self.MST.adicionaAresta("a11", '8', '6', 3)
        self.MST.adicionaAresta("a12", '8', '2', 2)
        self.MST.adicionaAresta("a13", '2', '5', 1)

        self.a1 = MeuGrafo(['A', 'B', 'C', 'D', 'E', 'F'])
        self.a1.adicionaAresta('a1', 'A', 'B', 7)
        self.a1.adicionaAresta('a2', 'B', 'A', 8)
        self.a1.adicionaAresta('a3', 'B', 'C', 9)
        self.a1.adicionaAresta('a4', 'C', 'E', 1)
        self.a1.adicionaAresta('a5', 'D', 'A', 4)
        self.a1.adicionaAresta('a6', 'A', 'F', 2)
        self.a1.adicionaAresta('a7', 'E', 'C', 1)
        self.a1.adicionaAresta('a8', 'A', 'A', 5)
        self.a1.adicionaAresta('a9', 'C', 'E', 6)
        self.a1.adicionaAresta('a10', 'B', 'F', 7)

        self.a2 = MeuGrafo(['A', 'B', 'C', 'D', 'E'])
        self.a2.adicionaAresta('a1', 'B', 'A', 2)
        self.a2.adicionaAresta('a2', 'A', 'D', 5)
        self.a2.adicionaAresta('a3', 'C', 'B', 1)
        self.a2.adicionaAresta('a4', 'D', 'E', 3)
        self.a2.adicionaAresta('a5', 'A', 'B', 6)
        self.a2.adicionaAresta('a6', 'D', 'D', 5)
        self.a2.adicionaAresta('a7', 'A', 'C', 7)
        self.a2.adicionaAresta('a8', 'B', 'E', 7)

        self.a3 = MeuGrafo(['Q', 'W', 'E', 'R', 'T', 'Y'])
        self.a3.adicionaAresta('a1', 'Q', 'W', 2)
        self.a3.adicionaAresta('a3', 'Q', 'T', 3)
        self.a3.adicionaAresta('a4', 'E', 'R', 4)
        self.a3.adicionaAresta('a5', 'R', 'W', 5)
        self.a3.adicionaAresta('a6', 'Q', 'E', 1)
        self.a3.adicionaAresta('a8', 'Y', 'E', 2)
        self.a3.adicionaAresta('a9', 'E', 'Q', 3)
        self.a3.adicionaAresta('a10', 'W', 'T', 4)
        self.a3.adicionaAresta('a11', 'Y', 'T', 5)
    ...
    def test_ha_ciclo(self):
        self.assertFalse(self.g_gsc.ha_ciclo())
        self.assertFalse(self.g_gsc2.ha_ciclo())
        self.assertEqual(self.g_p.ha_ciclo(), ['C', 'a4', 'P', 'a5', 'C'])

    def test_caminho(self):
        self.assertEqual(self.g_gsc.caminho(3), ['J', 'a1', 'C', 'a2', 'E'])
        self.assertEqual(self.g_gsc.caminho(4), ['J', 'a1', 'C', 'a2', 'E', 'a3', 'P'])
        self.assertEqual(self.g_l1.caminho(1), ['A'])
        self.assertEqual(self.g_p.caminho(2), ['J', 'a1', 'C'])
        self.assertEqual(self.g_p.caminho(8), False)

    def test_conexo(self):
        self.assertFalse(self.g_d.conexo())
        self.assertFalse(self.g_gsc.conexo())
    ...
    def teste_dijkstra_drone(self):
        self.assertEqual(self.g_p.dijkstra_drone('J', 'P'), ['P-C', 'C-J'])
        self.assertEqual(self.g_p.dijkstra_drone('C', 'Z'), ['Z-T', 'T-C'])
        self.assertEqual(self.g_p2.dijkstra_drone('J', 'Z'), ['Z-T', 'T-C', 'C-J'])
        self.assertEqual(self.g_p2.dijkstra_drone('E', 'T'), ['T-C', 'C-E'])
        self.assertEqual(self.g_c.dijkstra_drone('J', 'E'), ['E-J'])

    def test_kruskall(self):
        self.assertEqual(self.MST.lista_kruskall(), ['5-6', '2-5', '6-7', '8-2', '7-0', '1-2', '2-3', '4-5'])
        self.assertEqual(self.a1.lista_kruskall(), ['E-C', 'A-F', 'D-A', 'A-B', 'B-C'])
        self.assertEqual(self.a2.lista_kruskall(), ['C-B', 'B-A', 'D-E', 'A-D'])
        self.assertEqual(self.a3.lista_kruskall(), ['Q-E', 'Q-W', 'Y-E', 'Y-E', 'Q-T', 'E-R'])

    def test_prim(self):
        self.assertEqual(self.MST.lista_prim(), ['7-0', '1-2', '2-5', '2-3', '4-5', '5-6', '6-7', '8-2'])
        self.assertEqual(self.a1.lista_prim(), ['A-F', 'B-C', 'E-C', 'C-E', 'D-A', 'B-F'])
        self.assertEqual(self.a2.lista_prim(), ['B-A', 'A-B', 'C-B', 'A-D', 'D-E'])
        self.assertEqual(self.a3.lista_prim(), ['Q-W', 'Q-E', 'E-Q', 'E-R', 'Q-T', 'Y-E'])